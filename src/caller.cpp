...
public:
  MyCall(Account &acc, MyPlayer *wp, int call_id = PJSUA_INVALID_ID)
      : Call(acc, call_id) {
    wav_player = wp;
    myAcc = (MyAccount *)&acc;
    rk_sema_init(&sem, 0);
